...
public class Principal extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sistema de Gestión para el Topico. Controle y administre de");

        jLabel3.setText("forma óptima y fácil el flujo de control de salud de los estudiantes UCV. ");

        jLabel4.setText("Esta herramienta le permitirá llevar un control completo y detallado de la salud de los estudiantes,");

        jLabel5.setText("tendrá acceso a herramientas especiales para tareas específicas, como lo son:");

        jLabel6.setText("• Estado de salud del estudiante");

        jLabel7.setText("• Generar reporte");

        jLabel8.setText("• Inventario de Productos");

        jLabel9.setText("• Seguimiento de traslado");
